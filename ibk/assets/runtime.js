...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Small screens use a scrollable stack instead of the desktop card canvas. */
  @media (max-width: 700px) {
    html, body { height: auto; min-height: 100%; overflow: auto; }
    #stage { position: static; overflow: visible; padding: 10px 10px 58px; }
    .pcard {
    ...
    .pcard-preview { height: 34svh !important; min-height: 190px; }
    .pcard-notes { max-height: 34svh; }
    .pcard-timer { min-height: 150px; }
    .pcard-head { min-height: 42px; padding: 10px 12px; }
    .pcard-body { min-height: 0; }
    .hint-bar {
      position: sticky; bottom: 0; flex-wrap: wrap;
      gap: 8px 12px; padding: 8px 10px;
      font-size: 10px;
    }
    .hint-bar > span:nth-child(3),
    .hint-bar > span:nth-child(4) { display: none; }
  }
</style>
</head>
<body>
